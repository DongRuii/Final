...
isstateList = []
f = open('/Users/rui/desktop/label 2.csv','r')
res = f.readlines()[1:]
for i in res:
    i_str = i.replace('\n','')
    ilist = i_str.split(',')
...
for item in findlist:
    ...
    target_pathT = os.path.abspath(r'/Users/rui/PycharmProjects/test1/Final/data2/train/'+item)
    source_pathV = os.path.abspath(r'/Users/rui/PycharmProjects/test1/Final/mess/'+item)
    target_pathV = os.path.abspath(r'/Users/rui/PycharmProjects/test1/Final/data2/val/'+item)
...
class DefaultConfig(object):
  ...
  #  model = 'ResNet34'  # 使用的模型，名字必须与models/__init__.py中的名字一致
    ...
    train_data_root = '/Users/rui/PycharmProjects/test1/Final/data2/train/'  # 训练集存放路径
    test_data_root = '/Users/rui/PycharmProjects/test1/Final/data2/val'  # 测试集存放路径
...
torch.save(model, '/Users/rui/PycharmProjects/test1/Final/model_2.pth')
...
model1 = torch.load('/Users/rui/PycharmProjects/test1/Final/model_2.pth')
